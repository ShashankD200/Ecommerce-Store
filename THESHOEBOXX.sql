...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2023 at 05:41 PM
...
INSERT INTO `product` (`id`, `pname`, `category`, `pprice`, `img`, `description`, `oprice`) VALUES
(1, 'Nike Airmax 2210', 'sports', 2000, 'nike1.webp', 'Upto 30% off on Card.', 3000),
(10, 'Puma White Sneakers', 'sneakers', 1499, 'puma1.webp', 'Free Delivery.', 2000),
(21, 'Puma Black Harbor Mist', 'sports', 1200, '3-377181-3-puma-black-harbor-mist-original-imagbfffc7ys7y6p.jpeg', 'High Quality Sole.', NULL),
(22, 'Puma Black Lime Squeeze', 'sports', 2500, '7-375499-7-puma-black-lime-squeeze-original-imagk8z5m3azgkey.jpeg', 'Original @Sports Shoes', NULL),
(23, 'Puma Black Apricot', 'sports', 5000, '10-391251-10-puma-black-apricot-white-original-imagjms5vhd8gjjp.jpeg', 'White | Black', NULL),
(24, 'Puma Black Siper', 'sports', 1500, '-original-imaggdk7nzyjgjd2.jpeg', 'Women | 7 | 5 | 4 | ', NULL),
(25, 'Puma Red Max', 'sports', 3000, '-original-imagg5drhw4zu3tb.jpeg', 'Red | 9 | 8 |', 4999),
(26, 'RedChief  Formal Shoes ', 'Formal', 2000, '6-54490041-6-liberty-black-original-imaghj75fet9kfmh.jpeg', 'Black / Size 7-10', 3999),
(27, 'Wood land Brown Leather ', 'Formal', 1500, '6-last-899-6-blue-horse-tan-original-imagh2v3uzavrpcg.jpeg', 'Brown Size 7-9', 2000),
(28, 'Equalizer 4.0 Casual Shoes', 'Casual', 3999, '-473Wx593H-460989160-black-MODEL.webp', '3-month warranty ', 4999);
...
INSERT INTO `productcart` (`id`, `userid`, `pname`, `pprice`, `img`, `description`, `quantity`) VALUES
(1, 3, 'Nike Airmax 2210', '2000', 'nike1.webp', 'Upto 30% off on Card.', 2),
(26, 9, 'Puma White Sneakers', '1499', 'puma1.webp', 'Free Delivery.', 2),
(27, 9, 'Nike Airmax 2210', '2000', 'nike1.webp', 'Upto 30% off on Card.', 1),
(28, 9, 'Puma Black Apricot', '5000', '10-391251-10-puma-black-apricot-white-original-imagjms5vhd8gjjp.jpeg', 'White | Black', 1),
(29, 12, 'Puma Black Siper', '1500', '-original-imaggdk7nzyjgjd2.jpeg', 'Women | 7 | 5 | 4 | ', 1),
(30, 12, 'Puma White Sneakers', '1499', 'puma1.webp', 'Free Delivery.', 1),
(31, 3, 'Puma White Sneakers', '1499', 'puma1.webp', 'Free Delivery.', 1),
(33, 3, 'RedChief  Formal Shoes ', '2000', '6-54490041-6-liberty-black-original-imaghj75fet9kfmh.jpeg', 'Black / Size 7-10', 1),
(34, 3, 'Puma Black Harbor Mist', '1200', '3-377181-3-puma-black-harbor-mist-original-imagbfffc7ys7y6p.jpeg', 'High Quality Sole.', 1),
(35, 3, 'Puma Black Siper', '1500', '-original-imaggdk7nzyjgjd2.jpeg', 'Women | 7 | 5 | 4 | ', 1),
(36, 3, 'Puma Black Harbor Mist', '1200', '3-377181-3-puma-black-harbor-mist-original-imagbfffc7ys7y6p.jpeg', 'High Quality Sole.', 1);
...
INSERT INTO `userdetail` (`id`, `Username`, `Password`, `email`, `mobile`) VALUES
(3, 'Shashank', '1234', 'shashank26dewangan@gmail.com', '989336214'),
(9, 'User', '1234', 'user@gmail.com', '252525'),
(12, 'Admin', '1234', 'admin@gmail.com', '1234');
